        ...
        <main className="container mx-auto px-4 py-12">
          <section className="mb-12">
            ...
            <p className="text-lg mb-4">
              At TeacherOP, we're on a mission to revolutionize education through the power of
              artificial intelligence. We believe that everyone deserves access to high-quality,
              personalized learning experiences that adapt to their unique needs, pace, and learning
              style.
            </p>
            <p className="text-lg">
              ...
              {[
                {
                  ...
                  description:
                    'Our AI analyzes your learning style and goals to create a unique educational journey.',
                },
                {
                  icon: <Users className="w-8 h-8 mb-4 text-primary" />,
                  title: 'Global Community',
                  description:
                    'Connect with learners worldwide, sharing insights and experiences across cultures.',
                },
                {
                  icon: <Zap className="w-8 h-8 mb-4 text-primary" />,
                  title: 'Adaptive Pacing',
                  description:
                    'Learn at your own speed with content that adjusts to your progress and comprehension.',
                },
                {
                  icon: <Globe className="w-8 h-8 mb-4 text-primary" />,
                  title: 'Multilingual Support',
                  description:
                    'Access courses in multiple languages, breaking down barriers to global education.',
                },
              ].map((feature, index) => (
                <Card key={index}>
          ...
          <section>
            ...
            <p className="text-lg mb-6">
              Experience the future of education with TeacherOP. Whether you're looking to acquire
              new skills, explore a passion, or advance your career, our AI-powered platform is here
