...
const WorkflowComponent = () => {
  ...
  return (
    <div className="mt-12 bg-gradient-to-br from-blue-50 to-purple-50 p-4 md:p-8 rounded-lg">
      <h3 className="text-3xl font-bold text-gray-800 mb-6 text-center">How TeacherOP Works</h3>
              ...
              <CardContent>
                {step.title === 'Universal Learning' ? (
                  <p className="text-sm text-gray-600">
                    ...
                    <span className="font-semibold text-teal-600"> sports</span>, and beyond.
                  </p>
                ) : (
