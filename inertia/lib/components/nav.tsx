...
import useCheckActiveNav from '../hooks/use_check_active_nav'
import { SideLink } from '../lib/data/side_links'
    ...
    <DropdownMenu>
      <Tooltip delayDuration={0}>
        ...
        <TooltipContent side="right" className="flex items-center gap-4">
          ...
          <Icons.chevronDown size={18} className="-rotate-90 text-muted-foreground" />
        </TooltipContent>
      </Tooltip>
