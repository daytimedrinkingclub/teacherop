  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 flex items-center justify-center">
      <div className="w-full max-w-6xl flex gap-4">
        ...
        <div
          className={`w-64 transition-all duration-300 ease-in-out ${showPalette ? 'opacity-100 visible' : 'opacity-0 invisible w-0'}`}
        >
      ...
      <AlertDialog open={showExitAlert} onOpenChange={setShowExitAlert}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This assessment must be taken in fullscreen mode. Please return to fullscreen to
              continue.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
